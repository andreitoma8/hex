...
const NAV_GROUPS = [
  ...
  { label: 'Issues', items: [{ href: '/issues', label: 'Board', icon: IconFindings }] },
];
      ...
      >
        ...
        <div className="px-5 pb-4 pt-6">
          <div className="flex items-baseline gap-2">
            ...
            <span className="text-caption text-text-tertiary">v0.4.2</span>
          </div>
        </div>
        ...
        <div className="border-t border-border-subtle px-3 py-3 space-y-1">
          ...
          <div className="flex items-center gap-1.5 px-3 py-1 text-caption text-text-tertiary">
            <kbd className="rounded border border-border-default bg-surface-2 px-1.5 py-0.5 text-[11px]">
              ⌘K
            </kbd>
            <span>Quick nav</span>
          </div>
